<form method="POST" action="<?= site_url('masters/room-status/update-room-status/'.$room_status->id); ?>" enctype="multipart/form-data" id="roleForm">
    <div class="card-body">
        <div class="form-group">    
            <label for="name">Room Status <sup class="text-danger">*</sup></label>
            <input type="text" name="room_status" class="form-control" id="room_status" placeholder="Room Status" value="<?= $room_status->room_status; ?>">
        </div>
    </div>
    <!-- /.card-body -->
