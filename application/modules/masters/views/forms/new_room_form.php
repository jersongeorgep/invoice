...
<form method="POST" action="<?= site_url('masters/room/save_room'); ?>" enctype="multipart/form-data" id="employeeForm">
    ...
    <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="number" name="room_no" class="form-control form-control-sm" id="room_no" placeholder="Room number">
        </div>
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="bathrooms_count" class="form-control form-control-sm" id="bathrooms_count" placeholder="No.of Bathrooms">
        </div>      
        <div class="form-group col-sm-4">
            ...
            <select class="form-control form-control-sm select2" name="room_status" id="room_status">
                ...
                <?php if(!empty($room_status)): ?>
                    <?php foreach($room_status as $value): ?>
                        <option value="<?= $value->id; ?>"><?= $value->room_status; ?></option>
                    <?php endforeach; ?>
                <?php endif; ?>
            </select>
        </div>
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="price" class="form-control form-control-sm text-right" id="price" placeholder="0.00">
        </div>

        <div class="form-group col-sm-4">
            <label for="extra_bed_price">Extra Bed Price<sup class="text-danger">*</sup></label>
            <input type="text" name="extra_bed_price" class="form-control form-control-sm text-right" id="extra_bed_price" placeholder="0.00">
        </div>  
