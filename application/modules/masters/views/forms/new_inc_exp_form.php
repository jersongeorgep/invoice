<form method="POST" action="<?= site_url('masters/income-expense-type/save-inc-exp-head'); ?>" enctype="multipart/form-data" id="categoriesForm">
    <div class="card-body row">
        <div class="form-group col-4">
            <label for="heads">Head Name <sup class="text-danger">*</sup></label>
            <input type="text" name="heads" class="form-control" id="heads" placeholder="Head Name">
        </div>
        <div class="form-group col-4">
