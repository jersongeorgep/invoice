<form method="POST" action="<?= site_url('masters/categories/update_category/'.$category->id); ?>" enctype="multipart/form-data" id="categoriesForm">
    <div class="card-body">
        <div class="form-group">
            <label for="category_name">Category Name <sup class="text-danger">*</sup></label>
            <input type="text" name="category_name" class="form-control" id="category_name" placeholder="Category Name" value="<?= $category->category_name; ?>">
        </div>
    </div>
    <!-- /.card-body -->
