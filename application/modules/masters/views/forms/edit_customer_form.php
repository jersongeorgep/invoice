<form method="POST" action="<?= site_url('masters/customers/update_customer/'.$customer->id); ?>" enctype="multipart/form-data" id="vendorsForm">
    <div class="card-body row">
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="text" name="post_code" class="form-control" id="post_code" placeholder="PIN Code" value="<?= $customer->post_code; ?>">
        </div>
        <div class="form-group col-6">
            ...
            <select name="post_office" id="post_office" class="form-control">
                <option value="<?= $customer->post_office; ?>"><?= $customer->post_office; ?></option>
            </select>
        </div>
        <div class="form-group col-sm-4">
            <label for="district">District</label>
            <input type="text" name="district" class="form-control" id="district" placeholder="District" readonly value="<?= $customer->district; ?>">
        </div>
        <div class="form-group col-sm-4">
            <label for="state">State</label>
            <input type="text" name="state" class="form-control" id="state" placeholder="State" readonly value="<?= $customer->state; ?>">
        </div>
        <div class="form-group col-sm-4">
            <label for="country">Country</label>
            <input type="text" name="country" class="form-control" id="country" placeholder="Country" readonly value="<?= $customer->country; ?>">
        </div>
        <div class="form-group col-sm-6">
        ...
        <div class="form-group col-sm-12">
            ...
            <input type="text" name="gst_no" class="form-control" id="gst_no" placeholder="GST No" value="<?= $customer->gst_no; ?>">
        </div>
        <div class="form-group col-sm-4">
            <label for="contact_person">Contact Person</label>
            <input type="text" name="contact_person" class="form-control" id="contact_person" placeholder="Contact Person" value="<?= $customer->contact_person; ?>">
        </div>
        <div class="form-group col-sm-4">
            <label for="owner">Owner</label>
            <input type="text" name="owner" class="form-control" id="owner" placeholder="Owner" value="<?= $customer->owner; ?>">
        </div>
        <div class="form-group col-sm-4">
            <label for="opening_balance">Opening Balance</label>
            <input type="text" name="opening_balance" class="form-control" id="opening_balance" placeholder="Opening Balance" value="<?= $customer->opening_balance; ?>">
        </div>
    </div>
    <!-- /.card-body -->
