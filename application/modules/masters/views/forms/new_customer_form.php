<form method="POST" action="<?= site_url('masters/customers/save_customer'); ?>" enctype="multipart/form-data" id="vendorsForm">
    <div class="card-body row">
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="text" name="post_code" class="form-control" id="post_code" placeholder="PIN Code">
        </div>
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="district" class="form-control" id="district" placeholder="District" readonly>
        </div>
        <div class="form-group col-sm-4">
            <label for="state">State</label>
            <input type="text" name="state" class="form-control" id="state" placeholder="State" readonly>
        </div>
        <div class="form-group col-sm-4">
            <label for="country">Country</label>
            <input type="text" name="country" class="form-control" id="country" placeholder="Country" readonly>
        </div>
        <div class="form-group col-sm-6">
        ...
        <div class="form-group col-sm-12">
            ...
            <input type="text" name="gst_no" class="form-control" id="gst_no" placeholder="GST No">
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="opening_balance" class="form-control" id="opening_balance" placeholder="Opening Balance">
        </div>
    </div>
    <!-- /.card-body -->
