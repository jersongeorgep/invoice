  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><span></span><a href="<?= site_url('masters/customers/add_new'); ?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> New </a> <button type="button" id="delete_btn" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Delete </button></span></h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped table-sm">
          <thead>
            <tr>
              ...
              <th class="text-center" width="10%">Receipts</th>
            ...
            ?>
              <?php foreach ($customers as $value) : ?>
                <tr>
                  ...
                  <td><?= $value->name; ?></td>
                  <td><?= $value->address; ?></td>
                  <td class="text-right"><?= number_format(get_total_sales('customer', $value->id),2); ?></td>
                  <td class="text-right"><?= number_format(get_total_receipts('all','','',$value->id),2); ?></td>
                  <td class="text-right"><?= number_format(customer_balance($value->id),2); ?></td>
                  <td><a href="<?= site_url('masters/customers/edit_customer/'. $value->id); ?>" class="btn btn-sm btn-secondary"><i class="fas fa-pencil-alt"></i></a></td>
                </tr>
              <?php
                $sl_no++;
              endforeach; ?>
