...
class Bed_size extends Admin_Controller {
	public function __construct(){
		parent::__construct();
		$this->data['pageHeading'] = 'Bed Sizes';
		$this->data['menu'] = 'Masters';
	}

	public function index(){
		$this->data['pageTitle']= 'Beds List';
		$this->data['sizes']	= $this->db->order_by('id', 'desc')->get('lms_bed_size')->result();
		$this->data['loadPage']	= "masters/bed_size/bed_size_lists";
