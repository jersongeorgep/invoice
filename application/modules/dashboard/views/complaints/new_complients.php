...
<form method="POST" action="<?= site_url('dashboard/complaints/save_complaints'); ?>" enctype="multipart/form-data" id="categoriesForm">
    <div class="card-body">
        <div class="row">
            <div class="form-group col-6">
                ...
                <div class="input-group date" id=complaint_date_time" data-target-input="nearest" readonly>
                    <input type="text" class="form-control form-control-sm datetimepicker-input" id="complaint_date_time" name="complaint_datetime" placeholder="Complaint Date" data-target="#complaint_date_time" value="<?= date('d-m-Y h:i a') ?>" />
            ...
            <div class="form-group col-12">
                ...
                <textarea name="complaints" class="form-control form-control-sm" id="complaints" placeholder="Complaints"></textarea>
            </div>
        </div>
    </div>
    <!-- /.card-body -->
