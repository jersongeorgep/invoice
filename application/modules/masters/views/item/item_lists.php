    ...
    <div class="col-12">
        <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <span>
                    <a href="<?= site_url('masters/item/add_new');?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> New </a>
                    <?php if($this->session->userdata('branch_id') == 1): ?>
                    <button type="button" id="delete_btn" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Delete </button>
                    <?php endif; ?>
                  </span>
                </h3>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-sm">
                  ...
                  <tr>
                    ...
                    <th width="2%" class="text-center"><input type="checkbox" id="select_all" name="select_all"></th>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="<?= site_url('masters/item/edit_item/'.$value->id);?>" class="btn btn-xs btn-flat btn-secondary"><i class="fa fa-edit"></i></a></td>
                  </tr>
                  <?php 
                    $sl_no++;
                    endforeach; ?>
    ...
    $('#delete_btn').on('click', function(){
        ...
        if(post_arr.length > 0){
            if(confirm("Do you really want to delete records?")){
                $.ajax({
                    type:"POST",
                    url : base_url + "masters/item/delete_item",
                    async:false,
                    cache :false,
                    data:{ids:post_arr},
