...
<form method="POST" action="<?= site_url('masters/shifts/update_shift/'.$shift->shift_id); ?>" enctype="multipart/form-data" id="categoriesForm">
    <div class="card-body row">
        <div class="form-group col-4">
            <label for="title">Title <sup class="text-danger">*</sup></label>
            <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="<?= $shift->title; ?>">
        </div>
        <div class="form-group col-4">
            <label for="category_name">Start Time</label>
            <input type="time" name="start_time"  class="form-control" id="start_time" placeholder="Start Time" value="<?= $shift->start_time; ?>">
        </div>
        <div class="form-group col-4">
            <label for="category_name">End Time</label>
            <input type="time" name="end_time" class="form-control" id="end_time" placeholder="End Time" value="<?= $shift->end_time; ?>">
        </div>
    </div>
    <!-- /.card-body -->
