<form method="POST" action="<?= site_url('masters/bed_size/update_size/'.$bed_size->id); ?>" enctype="multipart/form-data" id="roleForm">
    <div class="card-body">
        <div class="form-group">
            <label for="name">Size <sup class="text-danger">*</sup></label>
            <input type="text" name="size" class="form-control" id="size" placeholder="Size" value="<?= $bed_size->size;?>">
        </div>
    </div>
    <!-- /.card-body -->
